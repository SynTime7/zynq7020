...
HD_PWD='D:/workspace/workspace_zynq/zynq7020/PS_DEV/mio_intr/mio_intr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq7020_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq7020_wrapper.tcl -notrace
