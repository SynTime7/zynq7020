...
HD_PWD='D:/workspace/workspace_zynq/zynq7020/PS_DEV/mio_intr/mio_intr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq7020_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq7020_wrapper.tcl
